...
export interface RadialOrbitalTimelineProps {
  ...
  /** Orbit radius in px (smaller for embedded sections). */
  orbitRadius?: number;
  className?: string;
}
...
export function RadialOrbitalTimeline({
  ...
  return (
    <div
      className={cn(
        "flex w-full flex-col items-center justify-center overflow-hidden bg-black",
        isSection ? "min-h-[min(640px,78dvh)] rounded-2xl py-6" : "h-screen",
        className
      )}
      ref={containerRef}
    ...
    >
      <div
        className={cn(
          ...
          isSection && "min-h-[520px] md:min-h-[560px]"
        )}
      >
        <div
        ...
        >
          ...
          <div
            className={cn(
              ...
              isSection ? "h-64 w-64 md:h-96 md:w-96" : "h-96 w-96"
            )}
          />
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    isExpanded ? "border-white" : isRelated ? "border-white" : ""
                  )}
                >
                  <Icon size={16} />
                </div>
                ...
                {isExpanded && (
                  <Card className="absolute left-1/2 top-20 w-64 max-w-[85vw] -translate-x-1/2 overflow-visible border-white/30 bg-black/90 shadow-xl shadow-white/10 backdrop-blur-lg">
